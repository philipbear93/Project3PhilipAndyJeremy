...
%% Plot 
figure(1)
fig_name1 = ['Position Plot Using Average Acceleration Method for 50 elements'];
plot(T,POSITION)
grid on
...
figure(2)
fig_name2 = ['Velocity Plot Using Average Acceleration Method for 50 Elements'];
plot(T, VELOCITY)
grid on
...
figure(3)
fig_name3 = ['Acceleration Plot Using Average Acceleration Method for 50 elements'];
plot(T, ACCELERATION)
grid on
